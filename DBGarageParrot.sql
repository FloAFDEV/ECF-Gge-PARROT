...
CREATE DATABASE DBGarageParrot
CHARACTER
SET utf8mb4
...
(
    ...
    manufacture_year YEAR NOT NULL
                    ...
                    (
                        ...
                        AUTO_INCREMENT PRIMARY KEY,
    fuel_type ENUM
                        ('Essence', 'Hybride', 'Electrique', 'Diesel') NOT NULL
) DEFAULT CHARACTER
                        SET utf8mb4
                        COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
    ...
    pseudo VARCHAR
                            (255) NOT NULL UNIQUE,
    role VARCHAR
                            (20) DEFAULT 'client' NOT NULL CHECK
                            (role IN
                            ('superAdmin', 'admin', 'employe', 'client')),
    password VARCHAR
                            (255) NOT NULL,
    ...
    Id_CarAnnonce INT,
    FOREIGN KEY
                                                (Id_CarAnnonce) REFERENCES CarAnnonce
                                                (Id_CarAnnonce)
) DEFAULT CHARACTER
                                                SET utf8mb4
                                                COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
    ...
    Id_Brand INT,
    FOREIGN KEY
                                                            (Id_Cars) REFERENCES Cars
                                                            (Id_Cars),
    FOREIGN KEY
                                                            (Id_Brand) REFERENCES Brands
                                                            (Id_Brand)
) DEFAULT CHARACTER
                                                            SET utf8mb4
                                                            COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
                                                            ...
                                                            INSERT INTO garage
                                                                (garageName, address, phoneNumber)
                                                            VALUES
                                                                ('Garage V.PARROT', '4 Impasse Paul Mesplé, 31000 TOULOUSE', '05 61 41 70 70');


                                                            -- Dans Opening
                                                            INSERT INTO Opening
                                                                (storeStatus, dayOfWeek, morningOpen, morningClose, eveningOpen, eveningClose, Id_Garage)
                                                            VALUES
                                                                ('Ouvert', 'Lundi', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 1),
                                                                ('Ouvert', 'Mardi', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 1),
                                                                ('Ouvert', 'Mercredi', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 1),
                                                                ('Ouvert', 'Jeudi', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 1),
                                                                ('Ouvert', 'Vendredi', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 1),
                                                                ('Ouvert', 'Samedi', '09:00:00', '12:00:00', NULL, NULL, 1),
...
MODIFY primaryGarage_Id INT NULL;
                                                            ...
                                                            INSERT INTO GarageServices
                                                                (serviceName, description, image_url, phoneNumber, Id_Garage)
                                                            VALUES
                                                                ('Réparation mécanique', 'Service complet de réparation automobile', 'service_image1.jpg', '05 61 41 70 71', 1),
                                                                ('Entretien régulier', 'Entretien et maintenance préventive', 'service_image2.jpg', '05 61 41 70 72', 1);


                                                            -- Dans Models

                                                            INSERT INTO Models
                                                                (Id_Brand, model_name, category_model)
                                                            VALUES
                                                                (1, '208', 'Citadine'),
                                                                (1, '3008', 'SUV'),
                                                                (2, 'CLIO', 'Citadine'),
